  ...
  return (
    <Modal open={open} onClose={handleClose} title="Uvoz uređaja" size="lg">
      ...
      <p className="mb-4 text-xs text-zinc-500 dark:text-zinc-500">
        Možete koristiti <code>companyId</code> ili <code>companyName</code>; ako oba postoje, koristi se{' '}
        <code>companyId</code>.
      </p>
      <div className="mb-4">
        <button
        ...
        {result && (
          <div className="mb-4 rounded border border-zinc-200 bg-zinc-50 p-3 text-sm dark:border-zinc-600 dark:bg-zinc-800/50">
            <p className="font-medium text-zinc-800 dark:text-zinc-200">
              Uveženo: {result.created} uređaja.
            </p>
